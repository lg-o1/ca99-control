...
pitch-direction.js ← 高低音方向感（零基础音高启蒙：弹一个参考音+方向⬆️/⬇️→你在琴上随便弹一个更高/更低的音，方向对且差得够明显就算对，不要求弹准某个音；大跳/五度/三度/一步之遥四关，连击越高门槛越小，纯逻辑出题/方向判定/状态机，18 单元测试）
    ...
    score-follow.js    ← 曲谱跟弹（Synthesia 式：内置 7 首乐曲/上传 MIDI 落音符到琴键、3 档训练、音名标签/节拍器/渐进提速/提示/区间循环/落点时间对比图、左右手分色/和弦/变速、力度可视化/真琴发声/每曲历史最高分/三星彩屑庆祝/随机选曲/练习足迹统计，纯逻辑，36 单元测试）
